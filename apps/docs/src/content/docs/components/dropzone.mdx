...
import { CfDropzone } from '@chufix/react';
...
<template>
  ...
  reactCode={`import { useState } from 'react';
import { CfDropzone, type DropzoneRejection } from '@chufix/react';
...
import { CfDropzone, type DropzoneFileStatus } from '@chufix/react';
