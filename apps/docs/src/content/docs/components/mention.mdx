...
import BasicVueSource from '~/components/demos/mention/BasicVue.vue?raw';
import TriggerVue from '~/components/demos/mention/TriggerVue.vue';
import TriggerVueSource from '~/components/demos/mention/TriggerVue.vue?raw';
import StatesVue from '~/components/demos/mention/StatesVue.vue';
import StatesVueSource from '~/components/demos/mention/StatesVue.vue?raw';
...
|---|---|---|---|
| `update:modelValue` | `onChange` | `string` | 文本任意变化时触发 |
| `select` | `onSelect` | `MentionOption` | 选中候选项时触发，载荷是被选中的原始 option |
