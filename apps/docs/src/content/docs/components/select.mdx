...
import { Select, type SelectOption } from '@chufix/react';
...
<DemoFrame
  vueCode={`<Select v-model="v1" :options="options" variant="outline" />
<Select v-model="v2" :options="options" variant="filled" />
<Select v-model="v3" :options="options" variant="ghost" />`}
  reactCode={`<Select value={v1} options={options} variant="outline" onChange={setV1} />
<Select value={v2} options={options} variant="filled" onChange={setV2} />
<Select value={v3} options={options} variant="ghost" onChange={setV3} />`}
>
...
<DemoFrame
  vueCode={`<Select v-model="a" :options="options" placeholder="可清空" clearable />
<Select v-model="b" :options="options" placeholder="禁用" disabled />
<Select v-model="b" :options="options" placeholder="错误状态" error />`}
  reactCode={`<Select value={a} options={options} clearable onChange={setA} />
<Select value={b} options={options} disabled />
<Select value={b} options={options} error />`}
>
