...
import BasicVueSource from '~/components/demos/empty/BasicVue.vue?raw';
import TextVue from '~/components/demos/empty/TextVue.vue';
import TextVueSource from '~/components/demos/empty/TextVue.vue?raw';
import ActionVue from '~/components/demos/empty/ActionVue.vue';
import ActionVueSource from '~/components/demos/empty/ActionVue.vue?raw';
import SizesVue from '~/components/demos/empty/SizesVue.vue';
import SizesVueSource from '~/components/demos/empty/SizesVue.vue?raw';
import IllustrationsVue from '~/components/demos/empty/IllustrationsVue.vue';
import IllustrationsVueSource from '~/components/demos/empty/IllustrationsVue.vue?raw';
import ImageVue from '~/components/demos/empty/ImageVue.vue';
import ImageVueSource from '~/components/demos/empty/ImageVue.vue?raw';
...
/>`}
  ...
  vueSource={IllustrationsVueSource}>
