...
import BasicVueSource from '~/components/demos/icon/BasicVue.vue?raw';
import SizesVue from '~/components/demos/icon/SizesVue.vue';
import SizesVueSource from '~/components/demos/icon/SizesVue.vue?raw';
import ColorsVue from '~/components/demos/icon/ColorsVue.vue';
import ColorsVueSource from '~/components/demos/icon/ColorsVue.vue?raw';
import MotionVue from '~/components/demos/icon/MotionVue.vue';
import MotionVueSource from '~/components/demos/icon/MotionVue.vue?raw';
