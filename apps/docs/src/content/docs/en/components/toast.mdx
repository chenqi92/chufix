...
import BasicVueSource from '~/components/demos/toast/BasicVue.vue?raw';
import TypesVue from '~/components/demos/toast/TypesVue.vue';
import TypesVueSource from '~/components/demos/toast/TypesVue.vue?raw';
import PositionVue from '~/components/demos/toast/PositionVue.vue';
import PositionVueSource from '~/components/demos/toast/PositionVue.vue?raw';
