...
import BasicVueSource from '~/components/demos/toc/BasicVue.vue?raw';
import NestedVue from '~/components/demos/toc/NestedVue.vue';
import NestedVueSource from '~/components/demos/toc/NestedVue.vue?raw';
import MaxDepthVue from '~/components/demos/toc/MaxDepthVue.vue';
import MaxDepthVueSource from '~/components/demos/toc/MaxDepthVue.vue?raw';
