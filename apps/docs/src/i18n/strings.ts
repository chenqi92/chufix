...
const dict = {
  zh: {
    ...
    'comments.emoji.label': '快捷 emoji 评论',
    'comments.emoji.send': '一键发送',
    'comments.emoji.aria': '发送',
    ...
    'comments.notice.needNick': '先填写昵称，再点 emoji 就能一键发送。',
  ...
  en: {
    ...
    'comments.emoji.label': 'Quick emoji reply',
    'comments.emoji.send': 'One-click send',
    'comments.emoji.aria': 'Send',
    ...
    'comments.notice.needNick': 'Fill in a nickname first, then tap an emoji to send.',
